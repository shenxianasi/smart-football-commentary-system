...
if __name__ == '__main__':  # 确保该模块被直接运行时才执行以下代码
    workers = 1
    batch = 32  # 适当等修改Batchsize，根据电脑等显存/内存设置，如果爆显存可以调低
    ...
    model = YOLO(model=r'D:\桌面\Offside detection\yolo11-seg-RFAConv.yaml', task='segment').load('./yolo11s-seg.pt')
